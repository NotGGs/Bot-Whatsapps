...
declare const makeChatsSocket: (config: LegacySocketConfig) => {
     ...
     */
    chatModify: (modification: ChatModification, jid: string, chatInfo: Pick<Chat, 'mute' | 'pin'>, timestampNow?: number | undefined) => Promise<void | {
        status: number;
    }>;
    /**
     ...
     */
    sendPresenceUpdate: (type: WAPresence, toJid?: string | undefined) => Promise<string>;
    /**
